    ...
    <div class="container d-flex flex-column align-items-center ">
        ...
        <div class="items-info border bg-white w-90 d-flex flex-column align-items-center relative">
            ...
            <div class="item w-80 ">
                ...
                <div class="row w-100 ">
                    <div class="info p-1 ">
                        <p class="mt-0 mb-0 font-family-arabic">
                        ...
                        <p class="mt-0 mb-0 font-family-arabic">
                            ...
                            منسق، أو حتى غير مفهوم. لأنه مازال نصاً بديلاً ومؤقتا
                        </p>
                        <p class="mt-0 mb-0 font-family-arabic">
                            هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص
                            العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة عدد الحروف
                    ...
                    <div class="images-lx p-2 flex-column justify-between">
                        <div class="relative h-100 d-flex align-items-center">
                            <img src="{{asset('images/redd-PTRzqc_h-4.png')}}" alt="" class="w-100 absolute slider-image image-1">
                            <img src="{{asset('images/md-duran-rE-3.png')}}" alt="" class="w-100 absolute slider-image image-2">
                            <img src="{{asset('images/wan-san-yip-ID-3.png')}}" alt="" class="w-100 absolute slider-image image-3">
                        </div>
