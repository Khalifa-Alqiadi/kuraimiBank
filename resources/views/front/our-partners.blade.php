    ...
    <div class="container d-flex flex-column align-items-center ">
        ...
        <div class="items-info border bg-white w-90 d-flex flex-column align-items-center relative">
            ...
            <div class="item w-100 d-flex flex-column align-items-center p-2">
                ...
                <div class="row w-100 p-3 border relative justify-center">
                    <div class="col-md-3">
                        <h2 class="fs-4">البنوك المراسلة</h2>
                    </div>
                    <div class="col-md-8">
                        <div class="item">
                            <h2 class="fs-5">المملكة العربية السعودية</h2>
                            <div class="row align-items-center">
                                <div class="col-md-3">
                                    <div class="bank-message">
                                        <img src="{{asset('images/mt1_s_pg.png')}}" alt="" class="border">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="bank-message">
                        ...
                        <div class="item">
                            <h2 class="fs-5">مملكة البحرين</h2>
                            <div class="row align-items-center">
                                <div class="col-md-3">
                                    <div class="bank-message">
                                        <img src="{{asset('images/mt1_s_pg.png')}}" alt="" class="border">
                        ...
                        <div class="item">
                            <h2 class="fs-5">الامارات العربية المتحدة</h2>
                            <div class="row align-items-center">
                                <div class="col-md-3">
                                    <div class="bank-message">
                                        <img src="{{asset('images/mt1_s_pg.png')}}" alt="" class="border">
                    ...
                    <div class="number absolute font-family-arabic text-light-color">3</div>
                </div>
                <div class="row w-100 p-3 border relative justify-center">
                    <div class="col-md-3">
                        <div class="partners-images d-flex justify-center align-items-center">
                    ...
                    <div class="number absolute font-family-arabic text-light-color">4</div>
                </div>
                <div class="row w-100 p-3 border relative justify-center">
                    <div class="col-md-3">
                        <div class="partners-images d-flex justify-center align-items-center">
                    ...
                    <div class="number absolute font-family-arabic text-light-color">5</div>
                </div>
            </div>
            <div class="item w-100 d-flex flex-column align-items-center p-2">
...
<section class="share share-icons partners-icons bg-white">
    <div class="container d-flex flex-column align-items-center">
