...
! function () {
    ...
    h = isDarkStyle ? (o = config.colors_dark.cardColor, e = config.colors_dark.headingColor, r = config.colors_dark.axisColor, a = config.colors_dark.borderColor, t = "dark", s = "#4f51c0", i = "#595cd9", c = "#8789ff", "#c3c4ff") : (o = config.colors.white, e = config.colors.headingColor, r = config.colors.axisColor, a = config.colors.borderColor, t = "", s = "#e1e2ff", i = "#c3c4ff", c = "#a5a7ff", "#696cff");
    var n = {
        donut: {
    ...
    var l = document.querySelector("#customerRatingsChart"),
        d = {
            ...
            xaxis: {
                ...
                categories: ["", `{{$Jab}}`, `{{$Feb}}`, "Mar", "Apr", "May", "Jun", "Jul"],
                axisBorder: {
                    show: !1
                }
            },
    ...
    l = document.querySelector("#salesActivityChart"), d = {
        chart: {
            type: "bar",
            height: 275,
            stacked: !0,
    ...
    l = document.querySelector("#sessionsChart"), d = {
        chart: {
            height: 90,
            type: "area",
            toolbar: {
    ...
    l = document.querySelector("#leadsReportChart"), d = {
        chart: {
            height: 157,
            width: 130,
    ...
    n = document.querySelector("#reportBarChart"), l = {
        chart: {
            height: 120,
            type: "bar",
            toolbar: {
    ...
    d = document.querySelector("#salesAnalyticsChart"), n = {
        chart: {
            height: 350,
            type: "heatmap",
            parentHeightOffset: 0,
    ...
    l = document.querySelector("#salesStats"), d = {
        chart: {
            height: 340,
            type: "radialBar"
        },
