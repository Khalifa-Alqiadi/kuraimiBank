  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <div data-i18n="{{__('categories.Categories')}}">{{__('categories.Categories')}}</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{route('categories_admin')}}" class="menu-link">
            <div data-i18n="{{__('categories.titleCategory')}}">{{__('categories.titleCategory')}}</div>
          </a>
        </li>
        <li class="menu-item">
