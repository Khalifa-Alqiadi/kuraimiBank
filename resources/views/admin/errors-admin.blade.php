...
<head>
    ...
    <style>
      ...
      .error-404{
        font-size: 200px;
        text-shadow: 1px 1px 3px 3px #342a4a;
      }
    </style>
...
<body>
    <div class="container mt-5">
        <div class="row">
            <div class="text-title text-center text-color my-5"><h1>عذرا لا تمتلك صلاحية الوصول!</h1></div>
            <div class="fw-blode text-center text-color error-404">403</div>
            <div class="">
                <a href="/"
                    class=" px-3 py-3 text-center"><h6  class=""><i class="fs fs-house-fill"></i>الرئيسية</h6></a>
            </div>
        </div>
    </div>
